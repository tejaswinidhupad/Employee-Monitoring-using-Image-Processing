...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<form action="addLeaveRequestServlet" method="post">
				...
				<br><br>
                <div class="form-group">
					<label class="col-sm-5 control-label">Select Type</label>
					<div class="col-sm-4">
						<select class="form-control eId" name="type">
								<option value="Paid" name="type">Paid</option>
								<option value="Unpaid" name="type">Unpaid</option>
							</select>
					</div>
